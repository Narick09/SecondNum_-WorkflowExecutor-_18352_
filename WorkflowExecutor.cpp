...
//итератор ведет себя как указатель, но он не указатель)
//ходит по контейнеру
//итератор - стандартный способ лазания по станд контейнерам.
//проверка на "конец" контейнера - тоже итератор
//
